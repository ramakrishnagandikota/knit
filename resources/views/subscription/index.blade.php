...
<body>
		...
		<ul class="pricing-list bounce-invert">
			<li class="@if(Auth::user()->hasSubscription('Free')) exclusive @endif ">
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible @if(Auth::user()->hasSubscription('Free')) is-ended @endif ">
						...
						<footer class="pricing-footer">
							<form id="subscriptionmonthly1">
								...
								<input type="hidden" name="s_type" id="s_type" value="Free">
								<input type="hidden" name="s_for" id="s_for" value="month">
							</form>
							@if(Auth::user()->hasSubscription('Basic') || Auth::user()->hasSubscription('Premium'))
			...
			<li @if(Auth::user()->hasSubscription('Basic')) exclusive @endif>
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible @if(Auth::user()->hasSubscription('Basic')) is-ended @endif">
						<header class="pricing-header">
							<h2>Basic</h2>
							<div class="price">
								<span class="currency">$</span>
					...
					<li data-type="monthly" class="is-visible">
						...
						<footer class="pricing-footer">
							<form id="subscriptionmonthly3">
								...
								<input type="hidden" name="s_type" id="s_type"  value="Premium">
								<input type="hidden" name="s_for"  id="s_for"  value="month">
							</form>
							@if(Auth::user()->hasSubscription('Premium'))
							<a class="select"  href="#">Selected</a>
