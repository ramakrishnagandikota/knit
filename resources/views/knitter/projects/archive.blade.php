                       ...
                       <div class="card-sub-custom">
                          <div class="card-block">
                             <div class="row">
                                ...
                                <a href="{{url('knitter/generate-custom-pattern/'.$gp->token_key.'/'.Str::slug($gp->name))}}">{{ucfirst($gp->name)}}</a>
                                @elseif($gp->pattern_type =='non-custom')
                                <a href="{{url('knitter/generate-noncustom-pattern/'.$gp->token_key.'/'.Str::slug($gp->name))}}">{{ucfirst($gp->name)}}</a>
                                @else
                                    <a href="{{url('knitter/generate-pattern/'.$gp->token_key.'/'.Str::slug($gp->name))}}">{{ucfirst($gp->name)}}</a>
                                @endif
                              </h6>
                                </div>
                             </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-8">
                                   ...
                                   @if($wp->pattern_type == 'custom')
                                    <a href="{{url('knitter/generate-custom-pattern/'.$wp->token_key.'/'.Str::slug($wp->name))}}"> {{ucfirst($wp->name)}}</a>
                                    @elseif($wp->pattern_type == 'non-custom')
                                    <a href="{{url('knitter/generate-noncustom-pattern/'.$wp->token_key.'/'.Str::slug($wp->name))}}"> {{ucfirst($wp->name)}}</a>
                                    @else
                                    <a href="{{url('knitter/generate-pattern/'.$wp->token_key.'/'.Str::slug($wp->name))}}"> {{ucfirst($wp->name)}}</a>
                                    @endif
                                  </h6>
                                </div>
                             </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-8">
                                   ...
                                   @if($com->pattern_type == 'custom')
                                    <a href="{{url('knitter/generate-custom-pattern/'.$com->token_key.'/'.Str::slug($com->name))}}"> {{ucfirst($com->name)}}</a>
                                    @elseif($com->pattern_type == 'non-custom')
                                    <a href="{{url('knitter/generate-noncustom-pattern/'.$com->token_key.'/'.Str::slug($com->name))}}"> {{ucfirst($com->name)}}</a>
                                    @else
                                    <a href="{{url('knitter/generate-pattern/'.$com->token_key.'/'.Str::slug($com->name))}}"> {{ucfirst($com->name)}}</a>
                                    @endif
                                  </h6>
                                </div>
                             </div>
