    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Measurement Calculations</h4>
...
<script type="text/javascript">
	$(function(){
		...
		$(document).on('click','.add-new',function(){
			$.get('{{url("admin/variable-view")}}',function(res){
		...
		$(document).on('click','#savem',function(){
			...
			if(formtype == 1){
				var Data = $("#insert-variable").serializeArray();
				var URL = '{{url("admin/variable-add")}}';
			}else{
				var Data = $("#update-variable").serializeArray();
				var URL = '{{url("admin/variable-update")}}';
			}
			...
			$.ajax({
				...
				success : function(res){
					if(res.status == 'fail'){
						...
						swal('Success','Variables added successfully.','success');
...
$(document).on('click','.edit',function(){
	...
	$.get('{{url("admin/variable-edit")}}/'+id,function(res){
		$("#measurementsaddedit").html(res);
	});	
});
		...
		$.ajax({
				...
				success : function(res){
					if(res.response == 'success'){
						swal('Success','Variable deleted successfully.','success');
						setTimeout(function(){ location.reload(); },2000);
					}else{
