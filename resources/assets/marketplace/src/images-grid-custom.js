    ...
    ImagesGridModal.prototype.renderInnerContainer = function() {
        ...
        this.$modal.append(
            $('<div>', {
                ...
                $('<div>', {
                    class: 'modal-control right toadddiv',
                    click: this.next
                }).append(
                    $('<div>', {
                        class: 'arrow right'
